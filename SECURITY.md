...
`walletwall-coinstellation` is a public-safe, read-only demo repository. It contains no live API integrations, no wallet connections, no transaction logic, and no production secrets.
...
- Real wallet addresses — all addresses are clearly labeled as demo
