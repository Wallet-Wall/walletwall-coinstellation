...
Thank you for your interest in `walletwall-coinstellation`.
...
- Bug fixes in the Coinstellation surface
...
See `docs/PUBLIC_SAFE_SCOPE.md` for the full exclusion list. In summary: no secrets, no live data connectors, no wallet connections, no signing or transaction logic, no vault write flows, no real wallet addresses or identity attribution.
